...
import {
  Search, Sparkles, ArrowRight, Bot, BookOpen,
  ChevronLeft, Wand2, GraduationCap, Lightbulb,
  Presentation, PenTool, Film, BrainCircuit,
} from 'lucide-react';
...
type WorkflowFrame = {
  ...
  chatSeed: string; // pre-seed chatbot message when entering builder
};
...
const CATEGORIES = ['Tất cả', 'Nghiên cứu', 'Thuyết trình', 'Viết lách', 'Sáng tạo', 'Lập trình', 'Học tập'];
